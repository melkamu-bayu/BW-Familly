    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _HubCard(icon: Icons.home_work_outlined, color: AppTheme.purple, title: 'Houses', subtitle: 'Houses, tenants and rent collection', onTap: () => context.go('/properties')),
          _HubCard(icon: Icons.storefront, color: AppTheme.orange, title: 'Shops', subtitle: 'Inventory, purchases and sales', onTap: () => context.go('/shop')),
          _HubCard(icon: Icons.apartment, color: AppTheme.green, title: 'Projects', subtitle: 'Investment, revenue, expenses and ROI', onTap: () => context.go('/gold-project')),
